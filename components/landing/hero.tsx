  ...
  return (
    ...
    >
      ...
      <div className="z-10 max-w-5xl mx-auto space-y-8">
        <h1
          ref={headline}
          className="text-6xl md:text-8xl font-black tracking-tighter leading-[1.1] text-transparent bg-clip-text bg-gradient-to-b from-white via-white/90 to-white/50"
        >
        ...
        >
          <Button
            size="lg"
            className="h-14 px-8 rounded-full bg-white text-black hover:bg-zinc-200 text-lg font-medium transition-all hover:scale-105 shadow-[0_0_20px_rgba(255,255,255,0.3)]"
          >
          ...
          <Button
            size="lg"
            variant="outline"
            className="h-14 px-8 rounded-full border-zinc-800 text-zinc-300 hover:bg-white/10 hover:text-white text-lg font-medium transition-all backdrop-blur-sm"
          >
