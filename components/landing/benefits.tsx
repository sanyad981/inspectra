      ...
      <div className="wrapper">
        <div className="max-w-2xl mx-auto mb-12 text-center">
          ...
          <p className="max-w-2xl mx-auto text-base dark: font-normal leading-6 text-white/50">
            Join thousands of developers who ship faster and with more
            confidence using AI-powered code reviews.
          </p>
        </div>
              ...
              <div className="benefits-bg rounded-[20px] p-12 overflow-hidden">
                ...
                <div>
                  ...
                  <p className="text-base max-w-sm text-white/70">
                    Stop waiting hours for code reviews. Get instant,
                    comprehensive feedback on every pull request in seconds.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="lg:px-12 p-8 bg-[#2D0B70] lg:pb-0 lg:p-12 relative rounded-[20px] h-full lg:flex lg:flex-row justify-between bg-cover flex-col gap-5">
                <div className="max-w-sm relative z-10">
                  ...
                  <p className="text-base text-white/70 mb-8">
                    Automated security scanning catches vulnerabilities before
                    they reach production. Stay compliant and protect your
                    users.
                  </p>
                  <Link
                    href="/signup"
