        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-zinc-500">
              ...
              <li><Link href="#" className="hover:text-zinc-300 transition-colors">Integrations</Link></li>
              <li><Link href="#" className="hover:text-zinc-300 transition-colors">Pricing</Link></li>
              <li><Link href="#" className="hover:text-zinc-300 transition-colors">Changelog</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-zinc-500">
              ...
              <li><Link href="#" className="hover:text-zinc-300 transition-colors">API Reference</Link></li>
