    ...
    return (
        <div className='space-y-4 '>
            ...
            <div className='relative'>
                ...
                />
                <Input type="text" placeholder='Search repositories' className='pl-8' value={searchQuery} onChange={(e) => { setSearchQuery(e.target.value) }} />
            ...
            <div className='grid  gap-4'>
                        ...
                        return (
                            <Card key={repo.id} className='hover:shadow-md transition-shadow'>
                                <CardHeader>
                                    <div className='flex items-center justify-between'>
                                        <div className='space-y-4 flex-1'>
                                            <div className='flex items-center gap-2'>
                                                ...
                                                {repo.isConnected && <Badge variant="outline">Connected</Badge>}
                                            </div>
                                        ...
                                        <div className='flex gap-2'>
                                            ...
                                            <Button
                                                ...
                                                variant={repo.isConnected || localConnectingId === repo.id ? "outline" : "default"}
                                            >
                                    ...
                                    <div>
                                        <p className='flex gap-2 items-center'><StarIcon className='h-4 w-4' />{repo.stargazers_count}</p>
                                    </div>
                ...
                <div ref={observerTarget} className="">
                    ...
                    {
                        !hasNextPage && (allRepositories?.length ?? 0) > 0 && (<p className='text-center text-muted-foreground'>No more repositories</p>)
                    }
                </div>
